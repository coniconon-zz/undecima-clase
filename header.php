...
<?php
$title = "DATAVIZ";
$description = "Antecedentes y referentes de sitios web y blogs que seleccionan proyectos interesantes sobre visualización de datos.";
...
<div class="row">
<div class="col-sm-12">
<h1><small><?php echo($description);?></small></h1>
</div><!--/col-sm-12-->
